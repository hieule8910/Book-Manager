...
public class HoaDonChiTietDAO {
    ...
    public List<HoaDonChiTiet> getAllHoaDonChiTiet() {
        ...
        String sSQL = "SELECT maHDCT, HoaDon.maHoaDon,HoaDon.ngayMua, Sach.maSach," +
                " Sach.maTheLoai,Sach.tenSach, Sach.tacGia, Sach.NXB, Sach.giaBia, Sach.soLuong," +
                "HoaDonChiTiet.soLuong FROM HoaDonChiTiet " +
